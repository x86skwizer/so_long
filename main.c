...
int main(int ac, char **av)
{
	...
	if (ac == 2)
	{
		...
		mlx.img_w = mlx_xpm_file_to_image(mlx.ptr, "./images/wall.xpm", &mlx.img_width, &mlx.img_height);
		mlx.img_p = mlx_xpm_file_to_image(mlx.ptr, "./images/ralph.xpm", &mlx.img_width, &mlx.img_height);
		mlx.img_c = mlx_xpm_file_to_image(mlx.ptr, "./images/trophy.xpm", &mlx.img_width, &mlx.img_height);
		mlx.img_e = mlx_xpm_file_to_image(mlx.ptr, "./images/door.xpm", &mlx.img_width, &mlx.img_height);
